...
@section('times_this_month', 'active')
...
<section class="vbox">
	<header class="header">
		<h2>GET times/this_month</h2>
	</header>
	<div class="padder">
		<p>
			Returns this month's prayer times based on given zone.
		</p>

		<h3>Resource URL</h3>
		<p>
			<pre>{{ Helper::site_domain() . '/times/this_month.json' }}</pre>
		</p>
