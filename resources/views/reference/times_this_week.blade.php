...
@section('times_this_week', 'active')
...
<section class="vbox">
	...
	<div class="padder">
		...
		<h3>Resource URL</h3>
		<p>
			<pre>{{ Helper::site_domain() . '/times/this_week.json' }}</pre>
		</p>
      ...
      <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Optional</td>
                  <td>
                    Define the preferred first day of week. <br>
                    <strong>Input:</strong> sunday / monday
                    <br><strong>Default:</strong> monday
                  </td>
                </tr>
              </tbody>
            </table>
