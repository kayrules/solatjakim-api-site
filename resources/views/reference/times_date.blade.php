...
<section class="vbox">
	<header class="header">
		<h2>GET times/date</h2>
	</header>
	<div class="padder">
		<p>
			Returns prayer times based on custom start date and end date for a given zone.
		</p>

		<h3>Resource URL</h3>
		<p>
			<pre>{{ Helper::site_domain() . '/times/date.json' }}</pre>
		</p>
			...
			<table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Required</td>
                  <td>Start date in format `dd-mm-yyyy`.</td>
                </tr>
                <tr>
                  <td><strong>end</strong></td>
                  <td>Optional</td>
                  <td>End date in format `dd-mm-yyyy`.</td>
                </tr>
                <tr>
